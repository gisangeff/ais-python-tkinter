...
def setTopFrame():
	topFrame = Frame(width="545", height="35", bg="#cc9090")
	topFrame.place(x=245, y=10)

	Label(topFrame, text="Search", padx=15, pady=4, bg="#cec2c2").place(x=7, y=6)
	...
	txtSearch.place(x=78, y=6)

	btnClose = Button(topFrame, text="Close", width=8, pady=2, relief="flat", command=quit)
	btnClose.place(x=455, y=6)
