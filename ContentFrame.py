...
def setContentFrame():
	...
	contentFrame = Frame(width="545", height="290", bg="#cc9090")
	...
	athletelist_tv.column(1, width=120, minwidth=120, stretch=NO)
	...
	athletelist_tv.column(7, width=60, minwidth=60, stretch=NO)
	athletelist_tv.place(x=13, y=5, width=505, height=250)
...
def save():
	...
	athletelist_tv.insert("", "end", values=(id, get_info[1], get_info[2], get_info[3],
											get_info[4], get_info[5], get_info[6], get_info[7]))
	saveToTextFile()
...
def update():
	...
	get_info = InfoFrame.get_info
	selected_row = athletelist_tv.selection()
	athletelist_tv.item(selected_row, values=(get_info[0], get_info[1], get_info[2], get_info[3],
											get_info[4], get_info[5], get_info[6], get_info[7]))
	saveToTextFile()
...
def addRow(list):
	...
	for i in range(len(list)):
		...
		athletelist_tv.insert("", "end", values=(view[0], view[1], view[2], view[3],
